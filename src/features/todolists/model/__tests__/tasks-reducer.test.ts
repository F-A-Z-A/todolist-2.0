...
test("status of specified task should be changed", () => {
  ...
  const action = updateTask({ task: startState["todolistId2"][1], updateParams: { status: TaskStatus.New } })
...
test("title of specified task should be changed", () => {
  ...
  const action = updateTask({ task: startState["todolistId2"][1], updateParams: { title: "coffee" } })
