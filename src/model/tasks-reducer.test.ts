...
test("correct task should be added to correct array", () => {
  ...
  const newTodolistId = "todolistId2";
  const newTodolistTitle = "juce";

  const action = addTaskAC(newTodolistId, newTodolistTitle);
  ...
  expect(endState["todolistId2"][0].title).toBe(newTodolistTitle);
